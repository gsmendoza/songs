...
#{
   ...
   \time 4/4
   \oneVoice
   r8 r8 r8 <g\3>8 <cis'\2 e\4 >4 <e'\1 e\4 >4 
   \bar "|."
   \pageBreak
#})
...
>>
TrackATabStaff = \new TabStaff \with { stringTunings = #`( ,(ly:make-pitch 0 2 NATURAL) ,(ly:make-pitch -1 6 NATURAL) ,(ly:make-pitch -1 4 NATURAL) ,(ly:make-pitch -1 1 NATURAL) ,(ly:make-pitch -2 5 NATURAL) ,(ly:make-pitch -2 1 NATURAL) ) } <<
